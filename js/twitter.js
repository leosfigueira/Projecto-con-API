var bearer = 'AAAAAAAAAAAAAAAAAAAAALkZEwEAAAAA6Pt0kRnnFL6cKazHDJGqPTtFmTU%3D57W0qYohs8SFtEmjVHrcgHUmsKVP3pmCJ4VgRPyw0xEcMLIpLE';
...
function getToken() {
	$.ajax({
		url: 'https://cors-anywhere.herokuapp.com/https://api.twitter.com/oauth2/token', //como twitter no admite cors usamos un servicio
		method: 'POST',
    //en ajax los headers se mandan juntos mo etán abajo
      ...
      //ahora twitter nos pide encodear en base64 y para eso usamos la funcion btoa apikey:apisecretkey
			'Authorization': 'Basic ' + btoa('2kI3eRldkJAD65W8Ob1ZurJBI:WItsOqdllM2fE9swvS0kgjEcN2TtVqafSsMd2fyE5yA0qVFY8c')
		},
...
function getTweets() {
	$.ajax({
		url: 'https://cors-anywhere.herokuapp.com/https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=edelpoficial',
		method: 'GET',
		headers: {
